"""Git-friendly flow serialization for harxitflow-sdk.

``normalize_flow`` transforms a raw HarxitFlow flow dict into a stable,
...
def normalize_flow(
    ...
    *,
    ...
    ----------
    flow:
        Raw flow dict as returned by the HarxitFlow API or read from a ``.json``
        file.
    strip_volatile:
