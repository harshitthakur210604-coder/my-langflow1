"""Pydantic models mirroring the HarxitFlow REST API request/response shapes."""
...
class Flow(BaseModel):
    """A flow returned by the HarxitFlow API."""
...
class Project(BaseModel):
    """A project (folder) returned by the HarxitFlow API."""
...
class RunOutput(BaseModel):
    ...
    def first_text(self) -> str | None:
        ...
        for component_out in self.outputs:
            ...
            # Standard HarxitFlow chat output: results -> message -> text
    ...
    def has_errors(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.has_errors()`` in harxitflow-ai/sdk
...
class RunResponse(BaseModel):
    ...
    # (adapted from harxitflow-ai/sdk, Janardan Singh Kavia, IBM Corp.,
    #  Apache 2.0 — https://github.com/harxitflow-ai/sdk/pull/1)
    # ------------------------------------------------------------------
    ...
    def get_chat_output(self) -> str | None:
        ...
        convention from the HarxitFlow V2 SDK::
    ...
    def is_completed(self) -> bool:
        ...
        ``WorkflowResponse.is_completed()`` in harxitflow-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_failed(self) -> bool:
        ...
        Adapted from ``WorkflowResponse.is_failed()`` in harxitflow-ai/sdk
        (Janardan Singh Kavia, IBM Corp., Apache 2.0).
        """
    ...
    def is_in_progress(self) -> bool:
        ...
        Included for API parity with :class:`BackgroundJob` and the HarxitFlow
...
class StreamChunk(BaseModel):
    ...
    Events emitted by the HarxitFlow backend:
