...
from harxitflow.schema.serialize import UUIDstr
...
from harxitflow.services.database.utils import (
...
class DeploymentProviderAccount(SQLModel, table=True):  # type: ignore[call-arg]
    ...
    # by a HarxitFlow alembic migration.  The enum is HarxitFlow-owned (see
    ...
    #   2. Register the corresponding adapter in LFX and mapper in HarxitFlow.
    #   3. Create a HarxitFlow alembic migration that runs:
    #        op.execute(
