...
from harxitflow.services.database.utils import validate_non_empty_string
...
class Deployment(SQLModel, table=True):  # type: ignore[call-arg]
    ...
    # ``deployment_type_enum`` constraint is defined by a HarxitFlow alembic
    ...
    #                           by the DB until a HarxitFlow migration adds it
    #                           to the enum type.  HarxitFlow explicitly opts
    ...
    #   2. Create a HarxitFlow alembic migration that runs:
