...
from harxitflow.services.adapters.deployment.watsonx_orchestrate.client import get_authenticator, get_provider_clients
from harxitflow.services.adapters.deployment.watsonx_orchestrate.constants import (
    SUPPORTED_ADAPTER_DEPLOYMENT_TYPES,
    ErrorPrefix,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.config import (
    list_configs as list_adapter_configs,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.create import (
    apply_provider_create_plan_with_rollback,
    build_provider_create_plan,
    validate_provider_create_request_sections,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.execution import (
    create_agent_run,
    get_agent_run,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.models import (
    fetch_models_adapter,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.retry import (
    retry_create,
    rollback_created_resources,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.status import (
...
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    extract_harxitflow_connections_binding,
    upload_tool_artifact_bytes,
    verify_tools_by_ids,
)
from harxitflow.services.adapters.deployment.watsonx_orchestrate.core.update import (
...
class WatsonxOrchestrateDeploymentService(BaseDeploymentService):
    ...
    async def update_snapshot(
        ...
        *,
        ...
        HarxitFlow flow name. This is intentional: the user may have set a
        ...
        * **Tool renamed in wxO console** — The new name is picked up
          ...
          HarxitFlow never stores the tool name locally.
        ...
        **Blast-radius boundary:** callers must verify that ``snapshot_id``
        is tracked by a HarxitFlow attachment record before calling this
        ...
        # been deployed with a custom name that differs from the HarxitFlow flow
