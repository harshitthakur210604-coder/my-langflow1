...
from harxitflow.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from harxitflow.services.store.schema import (
...
from harxitflow.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.harxitflow.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates harxitflow with the store which is a Directus instance.
