...
from harxitflow.helpers.user import get_user_by_flow_id_or_endpoint_name
from harxitflow.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_WARNING
...
from harxitflow.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default HarxitFlow authentication service (implements LFX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        from harxitflow.services.auth.utils import ACCESS_TOKEN_TYPE, get_jwt_verification_key
