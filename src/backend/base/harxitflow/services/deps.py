...
if TYPE_CHECKING:
    ...
    from harxitflow.services.cache.service import AsyncBaseCacheService, CacheService
    from harxitflow.services.chat.service import ChatService
    ...
    from harxitflow.services.state.service import StateService
    from harxitflow.services.store.service import StoreService
    from harxitflow.services.task.service import TaskService
    from harxitflow.services.tracing.service import TracingService
    from harxitflow.services.variable.service import VariableService
...
from harxitflow.services.job_queue.service import JobQueueService  # noqa: TC001
from harxitflow.services.storage.service import StorageService  # noqa: TC001
from harxitflow.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from harxitflow.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from harxitflow.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from harxitflow.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from harxitflow.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from harxitflow.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from harxitflow.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from harxitflow.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> Union[CacheService, AsyncBaseCacheService]:  # noqa: UP007
    ...
    """
    from harxitflow.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from harxitflow.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from harxitflow.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from harxitflow.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from harxitflow.services.job_queue.factory import JobQueueServiceFactory
...
def get_auth_service() -> BaseAuthService:
    ...
    from harxitflow.services.auth.factory import AuthServiceFactory
...
def get_job_service():
    ...
    """
    from harxitflow.services.jobs.factory import JobServiceFactory

    return get_service(ServiceType.JOB_SERVICE, JobServiceFactory())


def get_flow_events_service():
    from harxitflow.services.flow_events.factory import FlowEventsServiceFactory
