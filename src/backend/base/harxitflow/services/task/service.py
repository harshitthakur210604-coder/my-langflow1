...
from harxitflow.exceptions.api import WorkflowResourceError, WorkflowServiceUnavailableError
from harxitflow.services.base import Service
from harxitflow.services.deps import get_queue_service
from harxitflow.services.task.backends.anyio import AnyIOBackend
from harxitflow.services.task.backends.celery import CeleryBackend

if TYPE_CHECKING:
    from lfx.services.settings.service import SettingsService

    from harxitflow.services.task.backends.base import TaskBackend
...
class TaskService(Service):
    ...
    async def revoke_task(self, task_id: UUID | str) -> bool:
        ...
        try:
            ...
            if str(e) != "HARXITFLOW_USER_CANCELLED":
                raise
            return True
        return True
