...
def create_harxitflow_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined HarxitFlow initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing HarxitFlow", "Setting up basic configuration"),
        ...
        ("Launching HarxitFlow", "Starting server and final setup"),
    ]
...
def create_harxitflow_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined HarxitFlow shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
