...
from harxitflow.api.v1.schemas import RunResponse
from harxitflow.api.v2.converters import (
    create_error_response,
    parse_flat_inputs,
    run_response_to_workflow_response,
)
from harxitflow.api.v2.workflow_reconstruction import reconstruct_workflow_response_from_job_id
from harxitflow.exceptions.api import (
...
from harxitflow.services.database.models.jobs.model import JobType
from harxitflow.services.database.models.user.model import UserRead
from harxitflow.services.deps import get_job_service, get_task_service
...
async def execute_sync_workflow(
    ...
    # Headers with prefix X-HARXITFLOW-GLOBAL-VAR-* are extracted and made available to components
