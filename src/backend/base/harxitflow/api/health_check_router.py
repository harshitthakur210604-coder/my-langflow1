...
from harxitflow.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the harxitflow instance is up
# therefore it's not a reliable health check for a harxitflow instance
...
# It's a reliable health check for a harxitflow instance
