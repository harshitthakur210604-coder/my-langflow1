...
from harxitflow.api.utils import CurrentActiveUser, check_harxitflow_version
from harxitflow.services.auth import utils as auth_utils
from harxitflow.services.deps import get_settings_service, get_store_service
from harxitflow.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_harxitflow_version(component)
