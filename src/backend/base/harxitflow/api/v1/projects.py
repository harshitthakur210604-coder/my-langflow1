...
from harxitflow.api.v1.mappers.deployments.sync import (
    retry_flow_operation_on_deployment_guard,
    retry_project_operation_on_deployment_guard,
)
from harxitflow.api.v1.mcp_projects import register_project_with_composer
from harxitflow.api.v1.projects_files import download_project_flows, upload_project_flows
from harxitflow.api.v1.projects_mcp_helpers import (
    cleanup_mcp_on_delete,
    handle_mcp_server_rename,
    register_mcp_servers_for_project,
)
from harxitflow.initial_setup.constants import ASSISTANT_FOLDER_NAME, STARTER_FOLDER_NAME
from harxitflow.services.auth.mcp_encryption import encrypt_auth_settings
from harxitflow.services.database.models.deployment.exceptions import (
    araise_if_deployment_guard_error_or_skip,
    remap_flow_guard_for_project_delete,
)
from harxitflow.services.database.models.deployment.guards import check_project_has_deployments
from harxitflow.services.database.models.deployment.orm_guards import ensure_flow_moves_allowed
...
from harxitflow.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from harxitflow.services.database.models.folder.pagination_model import FolderWithPaginatedFlows
from harxitflow.services.deps import get_service, get_settings_service
...
async def delete_project(
    *,
    ...
    # Prevent deletion of the HarxitFlow Assistant folder
