...
from harxitflow.api.v1.schemas import Token
...
from harxitflow.services.deps import get_auth_service, get_settings_service, get_variable_service
...
async def get_session(
    ...
    """
    from harxitflow.services.auth.utils import oauth2_login
