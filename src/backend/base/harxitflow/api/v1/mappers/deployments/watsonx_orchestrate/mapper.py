...
from harxitflow.api.v1.mappers.deployments.base import (
...
from harxitflow.api.v1.mappers.deployments.registry import register_mapper
...
class WatsonxOrchestrateDeploymentMapper(BaseDeploymentMapper):
    ...
    async def resolve_rollback_update(
        ...
        *,
        ...
        """
        from harxitflow.services.database.models.deployment.crud import get_deployment
        from harxitflow.services.database.models.flow_version_deployment_attachment.crud import (
