...
class DeploymentApiPayloads(DeploymentPayloadFields):
    ...
    Ownership boundary:
    HarxitFlow owns API slot population here because API payloads may include
    HarxitFlow-specific references and reshaping requirements. Adapter-side
...
class BaseDeploymentMapper:
    ...
    - Mapper: API-boundary translation/validation (HarxitFlow schemas <-> adapter payloads).
    ...
    HarxitFlow-aware resolution or payload reshaping.
    """
