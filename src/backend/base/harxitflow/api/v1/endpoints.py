...
from harxitflow.api.utils import CurrentActiveUser, DbSession, extract_global_variables_from_headers, parse_value
from harxitflow.api.v1.files import get_flow
from harxitflow.api.v1.schemas import (
    ConfigResponse,
...
from harxitflow.events.event_manager import create_stream_tokens_event_manager
from harxitflow.exceptions.api import APIException, InvalidChatInputError
from harxitflow.exceptions.serialization import SerializationError
from harxitflow.helpers.flow import get_flow_by_id_or_endpoint_name
from harxitflow.interface.initialize.loading import update_params_with_load_from_db_fields
from harxitflow.processing.process import process_tweaks, run_graph_internal
from harxitflow.schema.graph import Tweaks
from harxitflow.services.auth.utils import (
    api_key_security,
    get_current_active_user,
    get_current_user_for_sse,
    get_optional_user,
)
from harxitflow.services.cache.utils import save_uploaded_file
from harxitflow.services.database.models.flow.model import Flow, FlowRead
from harxitflow.services.database.models.flow.utils import get_all_webhook_components_in_flow
from harxitflow.services.database.models.user.model import User, UserRead
from harxitflow.services.deps import get_auth_service, get_session_service, get_settings_service, get_telemetry_service
from harxitflow.services.event_manager import create_webhook_event_manager, webhook_event_manager
from harxitflow.services.telemetry.schema import RunPayload
...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-HARXITFLOW-GLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-HARXITFLOW-GLOBAL-VAR-*
...
# get endpoint to return version of harxitflow
@router.get("/version")
