...
from harxitflow.api.utils import extract_global_variables_from_headers
from harxitflow.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
from harxitflow.api.v1.schemas import SimplifiedAPIRequest
...
from harxitflow.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from harxitflow.schema.content_types import ToolContent
from harxitflow.services.auth.utils import api_key_security
from harxitflow.services.database.models.flow.model import FlowRead
from harxitflow.services.database.models.user.model import UserRead
from harxitflow.services.deps import get_telemetry_service
from harxitflow.services.telemetry.schema import RunPayload
from harxitflow.services.telemetry.service import TelemetryService
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert HarxitFlow events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified HarxitFlow flow.
    ...
    # Extract global variables from X-HARXITFLOW-GLOBAL-VAR-* headers
