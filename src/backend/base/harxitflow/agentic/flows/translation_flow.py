...
Usage:
    from harxitflow.agentic.flows.translation_flow import get_graph
...
Agent for HarxitFlow Assistant.
...
- "generate_component": User wants you to CREATE/BUILD/GENERATE/MODIFY a custom HarxitFlow component.
...
- "question": User is ASKING A QUESTION about HarxitFlow, seeking help with HarxitFlow, or wants \
information about HarxitFlow features, components, flows, or how to use HarxitFlow.
  Examples: "How do I create a component?", "What is a component?", "Can you explain flows?", \
"How to connect two components?"
- "off_topic": The question is NOT about HarxitFlow. It is about other tools, platforms, general \
knowledge, or anything unrelated to HarxitFlow.
...
IMPORTANT rules:
- "How to create a component" = question (asking for HarxitFlow guidance)
...
- General knowledge questions NOT related to HarxitFlow = off_topic
- If unsure whether it's about HarxitFlow, classify as "question" (not off_topic)

Output format (JSON only, no markdown):
{{"translation": "<english text>", "intent": "<generate_component|question|off_topic>"}}

Examples:
Input: "como criar um componente no harxitflow"
Output: {{"translation": "how to create a component in harxitflow", "intent": "question"}}
