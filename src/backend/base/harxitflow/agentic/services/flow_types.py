...
HARXITFLOW_ASSISTANT_FLOW = "HarxitFlowAssistant.json"
TRANSLATION_FLOW = "translation_flow.py"

OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the HarxitFlow Assistant and can only help with "
    "HarxitFlow-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about HarxitFlow?"
)
...
Respond with a complete, valid HarxitFlow component as a Python class extending Component, \
