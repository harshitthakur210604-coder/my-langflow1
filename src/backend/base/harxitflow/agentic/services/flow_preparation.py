...
# Relative path embedded in the bundled HarxitFlowAssistant.json flow for the
...
# case for a packaged install (HarxitFlow Desktop, `pip install harxitflow`,
...
def inject_lfx_components_path(flow_data: dict) -> dict:
    ...
    The bundled HarxitFlowAssistant flow hardcodes a relative path that only
    ...
    be a directory.", causing the HarxitFlow Assistant to fail with
