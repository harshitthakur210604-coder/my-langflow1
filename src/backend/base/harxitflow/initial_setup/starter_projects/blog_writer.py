...
""")
    ...
    url_component.set(urls=["https://harxitflow.org/", "https://docs.harxitflow.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about HarxitFlow and AI. "
