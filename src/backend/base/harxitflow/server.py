...
class HarxitFlowUvicornWorker(UvicornWorker):
...
class HarxitFlowApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "harxitflow.server.HarxitFlowUvicornWorker"
