...
class TestRemoveSqliteLockFiles:
    ...
    def test_should_remove_all_lock_files(self, kb_dir):
        from harxitflow.api.utils.kb_helpers import _remove_sqlite_lock_files
...
class TestTruncateSqliteFiles:
    ...
    def test_should_truncate_sqlite_files_to_zero(self, kb_dir):
        from harxitflow.api.utils.kb_helpers import _truncate_sqlite_files
...
class TestReleaseChromaResources:
    ...
    def test_should_clear_registry_entry_for_path(self, kb_dir):
        ...
        from harxitflow.api.utils.kb_helpers import KBStorageHelper
    ...
    @patch("harxitflow.api.utils.kb_helpers.gc.collect")
...
class TestDeleteStorage:
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_fresh_chroma_client", new=MagicMock())
    @patch("harxitflow.api.utils.kb_helpers.Chroma", new=MagicMock())
    @patch("harxitflow.api.utils.kb_helpers.time.sleep", new=MagicMock())
    ...
    def test_should_retry_and_succeed_on_second_attempt(self, kb_dir):
        ...
        with patch("harxitflow.api.utils.kb_helpers.shutil.rmtree", side_effect=rmtree_fails_once):
            result = KBStorageHelper.delete_storage(kb_dir, "test_kb")
    ...
    def test_should_rename_as_fallback_when_all_retries_fail(self, kb_dir):
        ...
        with patch(
            "harxitflow.api.utils.kb_helpers.shutil.rmtree",
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_fresh_chroma_client", new=MagicMock())
    @patch("harxitflow.api.utils.kb_helpers.Chroma", new=MagicMock())
    @patch("harxitflow.api.utils.kb_helpers.time.sleep")
    def test_should_use_exponential_backoff_on_retries(self, mock_sleep, kb_dir):
        ...
        with patch("harxitflow.api.utils.kb_helpers.shutil.rmtree", side_effect=rmtree_fails_three_times):
            result = KBStorageHelper.delete_storage(kb_dir, "test_kb")
...
class TestDeleteEndpoint:
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.delete_storage", return_value=False)
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
...
class TestBulkDeleteEndpoint:
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.delete_storage")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.delete_storage", new=MagicMock(return_value=True))
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
