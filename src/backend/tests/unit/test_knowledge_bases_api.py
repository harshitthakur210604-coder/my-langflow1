...
from harxitflow.api.utils.kb_helpers import (
    KBAnalysisHelper,
    KBIngestionHelper,
    KBStorageHelper,
)
...
class TestGetKBMetaData:
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("harxitflow.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_provider")
    @patch("harxitflow.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_model")
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
...
class TestKnowledgeBaseAPI:
    ...
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("harxitflow.api.v1.knowledge_bases.logger.warning")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("harxitflow.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("harxitflow.api.v1.knowledge_bases.get_job_service")
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.delete_storage", return_value=True)
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("harxitflow.api.v1.knowledge_bases.logger")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("harxitflow.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("harxitflow.api.v1.knowledge_bases.get_job_service")
    @patch("harxitflow.api.v1.knowledge_bases.get_task_service")
    ...
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("harxitflow.api.v1.knowledge_bases.Chroma")
...
class TestPerformIngestionTask:
    ...
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_fresh_chroma_client")
    @patch("harxitflow.api.utils.kb_helpers.Chroma")
    @patch("harxitflow.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("harxitflow.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("harxitflow.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("harxitflow.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("harxitflow.api.utils.kb_helpers.Chroma")
    @patch("harxitflow.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("harxitflow.api.utils.kb_helpers.KBIngestionHelper.cleanup_chroma_chunks_by_job", new_callable=AsyncMock)
...
class TestCancelIngestion:
    ...
    @patch("harxitflow.api.v1.knowledge_bases.KBIngestionHelper.cleanup_chroma_chunks_by_job")
    @patch("harxitflow.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("harxitflow.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    async def test_cancel_ingestion_success(
        ...
        with mock_patch("harxitflow.services.deps.get_service", side_effect=get_service_side_effect):
            response = await client.post(
