from harxitflow.processing.process import process_tweaks
from harxitflow.services.deps import get_session_service
from harxitflow.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from harxitflow.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("harxitflow.processing.process.logger") as mock_logger:
