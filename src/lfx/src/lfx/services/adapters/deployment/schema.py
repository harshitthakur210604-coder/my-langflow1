...
class DeploymentType(str, Enum):
    ...
    **Cross-package coupling** — harxitflow's ``Deployment`` database model
    (``harxitflow.services.database.models.deployment.model``) persists this
...
class SnapshotDeploymentBindingUpdate(BaseModel, Generic[T_FlowProviderData]):
    ...
    def validate_operations(self):
        ...
        # add_raw_payloads carry flow-artifact IDs (HarxitFlow domain),
