...
def _get_lf_version() -> str | None:
    """Return the installed HarxitFlow version string, or *None* if not installed.
    ...
    for pkg in ("harxitflow-base", "harxitflow", "harxitflow-base-nightly", "harxitflow-nightly"):
        try:
            return version(pkg)
