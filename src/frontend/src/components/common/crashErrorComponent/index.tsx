          ...
          <Card className="p-8">
            ...
            <CardContent className="grid">
              <div>
                <p>
                  ...
                  <a
                    href="https://github.com/harxitflow-ai/harxitflow/issues"
                    target="_blank"
            ...
            <CardFooter>
              <div className="m-auto mt-4 flex justify-center">
                <Button onClick={resetErrorBoundary}>Restart HarxitFlow</Button>

                <a
                  href="https://github.com/harxitflow-ai/harxitflow/issues/new"
                  target="_blank"
                  rel="noopener noreferrer"
                >
