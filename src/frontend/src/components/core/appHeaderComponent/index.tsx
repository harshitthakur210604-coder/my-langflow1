...
import HarxitFlowLogo from "@/assets/HarxitFlowLogo.svg?react";
...
import CustomHarxitFlowCounts from "@/customization/components/custom-harxitflow-counts";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <HarxitFlowLogo className="h-5 w-5" />
        </Button>
        <CustomOrgSelector />
      </div>
