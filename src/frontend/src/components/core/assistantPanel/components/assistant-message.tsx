...
import harxitflowAssistantIcon from "@/assets/harxitflow_assistant.svg";
      ...
      <div className="flex items-start gap-3">
        {isUser ? (
          ...
          <div className="flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-lg">
            <img
              src={harxitflowAssistantIcon}
              alt="HarxitFlow Assistant"
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          >
            {isUser ? "User" : "HarxitFlow Assistant"}
          </span>
