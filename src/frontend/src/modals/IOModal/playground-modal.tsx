//import HarxitFlowLogoColor from "@/assets/HarxitFlowLogocolor.svg?react";
...
import { HarxitFlowButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const HarxitFlowButtonClick = () => {
    track("HarxitFlowButtonClick");
    customOpenNewTab(HarxitFlowButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={HarxitFlowButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <HarxitFlowLogoColor />
                      <div className="text-sm">
                        {t("modal.io.builtWithHarxitFlow")}
                      </div>
                    </Button>
                  </div>
                )}
            ...
            {!sidebarOpen && showPublishOptions && (
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                <ShadTooltip
                  styleClasses="z-50"
                  side="right"
                  content={t("modal.io.builtWithHarxitFlowTooltip")}
                >
                  <Button
                    variant="primary"
                    ...
                    onClick={HarxitFlowButtonClick}
                  >
                    <HarxitFlowLogoColor className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
