...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the HarxitFlow documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "HarxitFlow: Create, Chain, Communicate.",
  ...
  "Design Dialogues with HarxitFlow.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret HarxitFlow API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const HARXITFLOW_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const HARXITFLOW_CHAT_TITLE = "HarxitFlow Chat";
...
export const STORE_TITLE = "HarxitFlow Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your HarxitFlow API key.";
...
export const HARXITFLOW_ACCESS_TOKEN = "access_token_lf";
export const HARXITFLOW_API_TOKEN = "apikey_tkn_lflw";
export const HARXITFLOW_AUTO_LOGIN_OPTION = "auto_login_lf";
export const HARXITFLOW_REFRESH_TOKEN = "refresh_token_lf";

export const HARXITFLOW_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const HARXITFLOW_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !getEnvVar("HARXITFLOW_AUTO_LOGIN") ||
  String(getEnvVar("HARXITFLOW_AUTO_LOGIN"))?.toLowerCase() !== "false";
...
export const GITHUB_URL = "https://github.com/harxitflow-ai/harxitflow";
export const TWITTER_URL = "https://x.com/harxitflow_ai";
export const DOCS_URL = "https://docs.harxitflow.org";
export const DATASTAX_DOCS_URL =
  "https://docs.datastax.com/en/harxitflow/index.html";
export const DESKTOP_URL = "https://www.harxitflow.org/desktop";
export const BUG_REPORT_URL = "https://github.com/harxitflow-ai/harxitflow/issues";
