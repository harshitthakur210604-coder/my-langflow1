...
# Start the backend
HARXITFLOW_DATABASE_URL=sqlite:///./temp HARXITFLOW_AUTO_LOGIN=True poetry run harxitflow run --backend-only --port 7860 --host 0.0.0.0 --no-open-browser > /dev/null 2>&1 &
