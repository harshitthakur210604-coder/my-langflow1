...
export class Web extends Construct {
  ...
  const websiteBucket = new s3.Bucket(this, 'HarxitFlowWebsiteBucket', commonBucketProps);

  const originAccessIdentity = new cloudfront.OriginAccessIdentity(
    this,
    'OriginAccessIdentity',
    {
      comment: 'harxitflow-distribution-originAccessIdentity',
    }
  );
  ...
  const cloudFrontWebDistribution = new cloudfront.Distribution(this, 'distribution', {
    comment: 'harxitflow-distribution',
