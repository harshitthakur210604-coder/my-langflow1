...
export class Rds extends Construct {
  ...
  constructor(scope: Construct, id: string, props: RdsProps) {
    ...
    const rdsCredentials = rds.Credentials.fromGeneratedSecret("db_user", {
      secretName: "harxitflow-DbSecret",
    });
    ...
    this.rdsCluster = new rds.DatabaseCluster(scope, "HarxitFlowDbCluster", {
      engine: rds.DatabaseClusterEngine.auroraMysql({
        version: rds.AuroraMysqlEngineVersion.of(
          "8.0.mysql_aurora.3.05.2",
          "8.0",
      ...
      instanceIdentifierBase: "harxitflow-instance",
      vpc: vpc,
      vpcSubnets: vpc.selectSubnets({
        subnetGroupName: "harxitflow-Isolated",
      }),
      securityGroups: [dbSG],
      ...
      defaultDatabaseName: "harxitflow",
    });
  }
}
