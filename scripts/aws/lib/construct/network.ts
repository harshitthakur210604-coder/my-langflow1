...
export class Network extends Construct {
  ...
  constructor(scope: Construct, id: string) {
    ...
    this.vpc = new ec2.Vpc(scope, 'VPC', {
      vpcName: 'harxitflow-vpc',
      ipAddresses: ec2.IpAddresses.cidr('10.0.0.0/16'),
      maxAzs: 3,
      subnetConfiguration: [
        {
          cidrMask: 24,
          name: 'harxitflow-Isolated',
          subnetType: ec2.SubnetType.PRIVATE_ISOLATED,
        },
        {
          cidrMask: 24,
          name: 'harxitflow-Public',
          subnetType: ec2.SubnetType.PUBLIC,
        },
        {
          cidrMask: 24,
          name: 'harxitflow-Private',
    ...
    this.alb = new elb.ApplicationLoadBalancer(this,'harxitflow-alb',{
      internetFacing: true, //インターネットからのアクセスを許可するかどうか指定
      loadBalancerName: 'harxitflow-alb',
    ...
    this.cluster = new ecs.Cluster(this, 'EcsCluster', {
      clusterName: 'harxitflow-cluster',
      vpc: this.vpc,
    ...
    this.ecsBackSG = new ec2.SecurityGroup(scope, 'ECSBackEndSecurityGroup', {
      securityGroupName: 'harxitflow-ecs-back-sg',
      description: 'for harxitflow-back-ecs',
      vpc: this.vpc,
    })
    ...
    this.dbSG = new ec2.SecurityGroup(scope, 'DBSecurityGroup', {
      ...
      securityGroupName: 'harxitflow-db',
      description: 'for harxitflow-db',
      vpc: this.vpc,
    })
    // harxitflow-ecs-back-sg からのポート3306:mysql(5432:postgres)のインバウンドを許可
    ...
    this.backendLogGroup = new logs.LogGroup(this, 'backendLogGroup', {
      logGroupName: 'harxitflow-backend-logs',
