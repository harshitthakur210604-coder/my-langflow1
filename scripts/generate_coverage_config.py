...
[run]
source = src/backend/base/harxitflow
omit =
    # Test files
    */tests/*
    */test_*
...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "harxitflow" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/harxitflow --cov-config=.coveragerc")
