...
Follow these best practices when submitting a template to HarxitFlow.

For template formatting examples, see [`/starter_projects`](https://github.com/harxitflow-ai/harxitflow/tree/main/src/backend/base/harxitflow/initial_setup/starter_projects) in the HarxitFlow repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [HarxitFlow repository](https://github.com/harxitflow-ai/harxitflow) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main HarxitFlow repository.
5. Include a screenshot of your template in the PR.

The HarxitFlow team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the HarxitFlow codebase.
...
For more information, see the HarxitFlow repository's [template categories](https://github.com/harxitflow-ai/harxitflow/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).