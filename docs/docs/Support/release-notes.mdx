...
- HarxitFlow MCP client for Bob (IBM) and Claude Code
    ...
    For more information, see [HarxitFlow MCP client for coding agents](../Agents/harxitflow-mcp-client.mdx).
...
- Build components with **HarxitFlow Assistant**
    ...
    **HarxitFlow Assistant** is an in-app virtual assistant that can create components from natural language prompts directly within the HarxitFlow workspace.
