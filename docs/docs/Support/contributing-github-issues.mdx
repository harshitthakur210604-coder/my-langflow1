...
The HarxitFlow GitHub repository is an integral part of the [HarxitFlow community](/contributing-community).

In addition to general assistance with HarxitFlow, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by HarxitFlow maintainers.

## GitHub issues

The [Issues page in the HarxitFlow repository](https://github.com/harxitflow-ai/harxitflow/issues) is actively updated with bugs and feature requests.
...
Use the [HarxitFlow repository's labels](https://github.com/harxitflow-ai/harxitflow/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or HarxitFlow in general, you can visit the [HarxitFlow GitHub Discussions page](https://github.com/harxitflow-ai/harxitflow/discussions) or reach out through other [HarxitFlow community](/contributing-community) channels.

The HarxitFlow team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the HarxitFlow team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The HarxitFlow team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading HarxitFlow or a dependency.
* **Describe your environment**: Include your operating system, HarxitFlow version, Python version, and any other environment-related details that could have contributed to the issue.
