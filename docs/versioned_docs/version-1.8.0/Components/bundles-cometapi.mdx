...
description: Use CometAPI models in HarxitFlow to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with HarxitFlow.
...
3. In HarxitFlow, add the **CometAPI** component to your flow.
