...
<Cards cols={3}>
  ...
  <Card icon={<Icon name="Cloud" size={20} />} title="Deploy" href="/deployment-overview">
    Deploy HarxitFlow to production environments.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Use the HarxitFlow API to run flows from your application code.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Build and deploy HarxitFlow as a containerized application.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Bot" size={20} />} title="HarxitFlow Agents" href="/agents">
    Build and configure AI agents with HarxitFlow.
  </Card>
  ...
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Expose HarxitFlow as an MCP server.
  </Card>
  <Card icon={<Icon name="Cable" size={20} />} title="MCP client" href="/mcp-client">
    Connect HarxitFlow to external MCP servers.
  </Card>
</Cards>
