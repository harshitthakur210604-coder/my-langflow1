...
:::tip
The ALTK contains features called _components_. These are different from HarxitFlow components. All components within ALTK are available through HarxitFlow's **ALTK Agent** component.
:::
...
For an example of the ALTK component in HarxitFlow, see the video tutorial [ALTK in HarxitFlow: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
