...
To integrate with HarxitFlow, add your LangWatch API key as a HarxitFlow environment variable:

1. Get a LangWatch API key from your LangWatch account.

2. Add the key to your HarxitFlow `.env` file:
...
3. Restart HarxitFlow with your `.env` file, if you modified the HarxitFlow `.env`:
