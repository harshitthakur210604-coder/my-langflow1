#!/usr/bin/env python3
"""Pull OpenAPI spec files from the harxitflow-ai/sdk repository.

This script is only for syncing external SDK specs when needed.
It is not used by the main HarxitFlow OpenAPI generation workflow,
...
REPO = "harxitflow-ai/sdk"
BRANCH = "main"
SPECS_DIR = "specs"
FILES = ["harxitflow-workflows-openapi.json", "harxitflow-openapi.json"]
